<div class="game" tabindex="0" id="game_id">
   ...
   <!-- BUTTONS  -->
   <div class="buttons_container wrap">


      <div class="button color1"  id="h1" onclick="fill_cell(97)">
      ...
      <div class="button color6" onclick="fill_cell(102)">
         <p>floor 6</p>
         <!-- <p>6</p> -->
         <div class="floor6">
            <div class="floor_wraper">
      ...
      <div class="button" id="delete_MOBILE" onclick="fill_cell(96)">
         <p>Delete</p>
      </div>
   ...
   <!-- PUZZLE GRID BOARD -->
   <!-- class="game_grid size_6x6" -->
   <div class="size_6x6" tabindex="0" id="game_grid_id">
      ...
      <div class="cell" id="0-5" onclick="highlight_cell(0,5)"></div>
      <div class=" clue" id="clue_6"></div>


      <div class=" clue" id="clue_22"></div>
      ...
      <div class="cell" id="1-5" onclick="highlight_cell(1,5)"></div>
      <div class=" clue" id="clue_7"></div>


      <div class=" clue" id="clue_21"></div>
      ...
      <div class="cell" id="2-5" onclick="highlight_cell(2,5)"></div>
      <div class=" clue" id="clue_8"></div>


      <div class=" clue" id="clue_20"></div>
      ...
      <div class="cell" id="3-5" onclick="highlight_cell(3,5)"></div>
      ...
      <div class="cell" id="4-5" onclick="highlight_cell(4,5)"></div>
      <div class=" clue" id="clue_10"></div>

      <div class=" clue" id="clue_18"></div>
      <div class="cell" id="5-0" onclick="highlight_cell(5,0)"></div>
      <div class="cell" id="5-1" onclick="highlight_cell(5,1)"></div>
      <div class="cell" id="5-2" onclick="highlight_cell(5,2)"></div>
      <div class="cell" id="5-3" onclick="highlight_cell(5,3)"></div>
      <div class="cell" id="5-4" onclick="highlight_cell(5,4)"></div>
      <div class="cell" id="5-5" onclick="highlight_cell(5,5)"></div>
   ...
   <div class="buttons_container">
      ...
      <div class="button" id="delete_DESKTOP" onclick="fill_cell(96)">
         <p>Delete</p>
      </div>
